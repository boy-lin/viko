...
export const ConverterLayer = () => {
  return (
    <div className="absolute bottom-0 left-4 right-4 h-40 translate-y-18 rounded-t-2xl bg-gradient-to-br from-purple-500 to-blue-500 p-6 transition-transform duration-[250ms] group-hover:translate-y-10 group-hover:rotate-[1deg] flex items-center justify-center z-10 pointer-events-none">
