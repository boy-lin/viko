...
export function buildDefaultArgs(mediaInfo: MediaDetails, task: ConverterTask) {
  ...
  const outputArgs: ConvertAudioTaskArgs = {
    ...
    format,
    audio_tracks: mediaInfo.streams
...
export default function TaskItem({
  ...
  const firstStream = taskMediaDetails?.streams.find((s) => s.codec_type === "audio");
