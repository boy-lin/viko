...
import { COMPRESSOR_UPLOAD_LABEL } from "./constants";
import { useCompressorStore } from "./store";

export default function CompressorHeader({
  globalFilter,
  ...
  const clearTasks = useCompressorStore((state) => state.clearTasks);
        ...
        <PopoverContent className="w-64" align="end">
          <div className="space-y-3">
            <div className="space-y-1">
              <h4 className="text-sm font-semibold">{tt("footer.confirm_delete_title")}</h4>
